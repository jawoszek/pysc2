...
def construct_network():
    ...
    b_2_l = Dense(18, activation='relu')(buildings_2_input)
    b_3_l = Dense(18, activation='relu')(buildings_3_input)
    b_4_l = Dense(18, activation='relu')(buildings_4_input)
    u_l = Dense(32, activation='relu')(units_input)
